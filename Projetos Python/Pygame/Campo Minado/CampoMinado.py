# Codigo criado com base de um video desafio
# que deveria terminar o jogo em 1hr, por
# isso o resultado pode não ser otimizado, ta com bug
import pygame
import random
...
pygame.display.set_caption('Campo Minadinho')
